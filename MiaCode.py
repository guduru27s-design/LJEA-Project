...
CHAR_CODES = [
    "BASINPERIM",  # Basin perimeter measured along entire drainage-basin divide
    "BSLDEM30FT",  # Mean basin slope, based on slope percent grid
    "CSL10_85fm",  # Change in elevation between points 10 and 85 percent of length along main channel to basin divide divided by length between points ft per mi
    "DRNAREA",     # Area that drains to a point on a stream
    "ELEV",        # Mean Basin Elevation
    "ELEVMAX",     # Maximum basin elevation
    "I24H50Y",     # Maximum 24-hour precipitation that occurs on average once in 50 years
    ...
    "LC11GRASS",   # Percent of area covered by grassland/herbaceous using 2011 NLCD
    "LC11IMP",     # Average percentage of impervious area determined from NLCD 2011 impervious dataset
    "LC11SHRUB",   # Percent of area covered by shrubland using 2011 NLCD
    "LC11WATER",   # Percent of open water, class 11, from NLCD 2011
    "LC11WETLND",  # Percentage of wetlands, classes 90 and 95, from NLCD 2011
    "LFPLENGTH",   # Length of longest flow path
    "MINBELEV",    # Minimum basin elevation
    "OUTLETELEV",  # Elevation of the stream outlet in feet above NAVD88
